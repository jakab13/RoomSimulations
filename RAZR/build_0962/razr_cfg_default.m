...
% RAZR_CFG_DEFAULT - Returns RAZR's default configuration.
%
% DO NOT EDIT THIS FILE!
%
% To change the configuration or to add fields, edit the file RAZR_CFG_USER.M.
% (It is automatically created when you run razr for the first time.)
% Internally, RAZR_CFG_USER overloads RAZR_CFG_DEFAULT.
% You can also create your own copy of RAZR_CFG_USER.M, e.g., a file called
% MY_RAZR_CFG.M. By editing the file SELECT_RAZR_CFG.M it can then be specified
% that your created MY_RAZR_CFG overloads RAZR_CFG_DEFAULT.
%
% Usage:
%   cfg = RAZR_CFG_DEFAULT
%
% See also: RAZR_CFG_USER, SELECT_RAZR_CFG
...
%% Paths to Directionality databases
cfg.dir_path__hs_filter = [];
