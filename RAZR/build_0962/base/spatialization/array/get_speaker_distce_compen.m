function [gains, delay_samples] = get_speaker_distce_compen(speaker_distances, op)
% GET_SPEAKER_DISTCE_COMPEN - Get gain and delay to compensate for
...
attenuation = distce_atten(speaker_distances, op.legacy_distce_atten);
gains = 1 ./ attenuation;
