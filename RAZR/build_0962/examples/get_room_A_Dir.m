...
%
% Reference:
% [1] Jeub, M., Schäfer, M., Vary, P. (2009): "A Binaural Room Impulse Response Database for the
...
% room.srcpos = [6.7, 25.3, 1.2];
% room.recpos = [6.3, 25.3, 1.2];
